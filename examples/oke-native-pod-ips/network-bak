...
resource "oci_core_security_list" "pods_subnet_sec_list" {
  compartment_id = var.compartment_ocid
  display_name   = "pods_subnet_sec_list"
  vcn_id         = oci_core_vcn.my_vcn.id
...
resource "oci_core_subnet" "pods_subnet" {
  ...
  security_list_ids          = [oci_core_vcn.my_vcn.default_security_list_id, oci_core_security_list.pods_subnet_sec_list.id]
  route_table_id             = oci_core_route_table.my_rt_via_natgw_and_sg.id
  prohibit_public_ip_on_vnic = true
}
...
resource "oci_core_subnet" "my_pods_nodepool_subnet" {
  cidr_block     = var.nodepool_subnet_cidr
  compartment_id = var.compartment_ocid
  vcn_id         = oci_core_vcn.my_vcn.id
  display_name   = "my_pods_nodepool_subnet"
